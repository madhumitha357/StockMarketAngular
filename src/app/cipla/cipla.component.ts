...
@Component({
  selector: 'app-cipla',
  templateUrl: './cipla.component.html',
  styleUrls: ['./cipla.component.css']
})
export class CiplaComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    const response = await fetch('assets/ExcelFiles/CIPLA.NS.csv');
