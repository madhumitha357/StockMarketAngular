...
@Component({
  selector: 'app-ashokley',
  templateUrl: './ashokley.component.html',
  styleUrls: ['./ashokley.component.css']
})
export class AshokleyComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    const response = await fetch('assets/ExcelFiles/ASHOKLEY.NS.csv');
